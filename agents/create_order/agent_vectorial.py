...
# Configurar knowledge base vetorial
...
agent = Agent(
    ...
    db=InMemoryDb(),
    knowledge=knowledge,  # Adiciona o knowledge base ao agente
    search_knowledge=True  # Ativa busca automática no knowledge base
)